        ...
        else
        {
            ...
            for (TrackableResult result : trackableResultList)
            {
                ...
                if (result.isOfType(DeviceTrackableResult.getClassType()))
                {
                    ...
                    mSurfaceAnchorCreationEnabled = (deviceTrackerResultStatus != DeviceTrackableResult.STATUS.NO_POSE);
                }
            ...
            else if (mCurrentMode == SAMPLE_APP_MIDAIR_MODE && !mMidAirAnchorCreationEnabled)
            {
